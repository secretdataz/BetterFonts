package app.jittapan.betterfonts.renderer;
...
public class StringRenderer
{
    ...
    public int renderString(String str, float startX, float startY, int initialColor, boolean shadowFlag)
    {
        ...
        // Fix mipmap breaking texts for some installations. Also save current value to restore after rendering.
