...
import me.suzutsuki.betterfonts.betterfonts.ConfigParser;
import me.suzutsuki.betterfonts.betterfonts.StringCache;
...
public class FontRenderer implements ResourceManagerReloadListener
{
    ...
    public FontRenderer(GameSettings par1GameSettings, ResourceLocation par2ResourceLocation, TextureManager par3TextureManager, boolean par4)
    {
        ...
        if(par2ResourceLocation.getResourcePath().equals("textures/font/ascii.png") && this.stringCache == null)
        {
